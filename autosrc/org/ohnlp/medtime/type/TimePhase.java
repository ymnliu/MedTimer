...
public class TimePhase extends TimeInterval {
  ...
  public final static int typeIndexID = JCasRegistry.register(TimePhase.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected TimePhase() {/* intentionally empty block */}
   ...
   */
  public TimePhase(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public TimePhase(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
